...
media: |
  ::: {layout-nrow=1 layout-ncol=2 layout-valign="center"}
  ![](/assets/img/collaboration_game_01.gif){
  fig-align=center
  fig-alt="Cyberball Animation"
  .lightbox group="collaboration" description="Collaboration game prototype 1"}

  ![](/assets/img/collaboration_game_02.png){
  fig-align=center
  fig-alt="Collaboration Game 2 Prototype"
  .lightbox group="collaboration" description="Collaboration game prototype 2"}
  :::
---
