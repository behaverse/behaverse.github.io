...
media:
  - |
    ![](/assets/img/cogtext_graph.png){
    fig-align=center
    fig-alt="CogText Knowledge Graph"
    .lightbox description="CogText knowledge graph links cognitive tasks and cognitive constructs; see [CogText paper](https://arxiv.org/abs/2203.11016) for details."}
links:
  - title: Paper
    icon: bi file-text
