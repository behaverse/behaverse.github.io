...
<video autoplay muted loop class="w-100">
    <source type="video/mp4" src="https://xcit.org/extras/behaverse-org/video/training/training_intro-lg-1080p.mp4">
</video>
```
...
```{=html}
<video autoplay muted loop class="w-100">
    <source type="video/mp4" src="https://xcit.org/extras/behaverse-org/video/training/training_section1_part1-lg-1080p.mp4">
</video>
```
:::
::::
...
```{=html}
<video autoplay muted loop class="w-100">
    <source type="video/mp4" src="https://xcit.org/extras/behaverse-org/video/training/training_section1_part2-lg-1080p.mp4">
</video>
```
:::
:::{#description}
...
![In the Monitoring module, participants search for specific symbols that may appear on the side panels, while ignoring other, distracting symbols.](https://xcit.org/extras/behaverse-org/img/training/training_section2_part1_left.jpg)

![In the Switching module, participants detect each time a signal matches particular rules that randomly switch across time.](https://xcit.org/extras/behaverse-org/img/training/training_section2_part1_center.jpg)

![In the Reaction module, participants must react as fast as possible to a signal and press the key corresponding to where the signal appeared.](https://xcit.org/extras/behaverse-org/img/training/training_section2_part1_right.jpg)
:::
...
](https://xcit.org/extras/behaverse-org/img/training/training_driving_trackpiece.jpg)

:::{layout-ncol="2"}

::::{#left}
{{< video https://xcit.org/extras/behaverse-org/video/training/training_section2_left-lg-1080p.mp4 >}}
The type of challenge determines the cognitive demands of the driving: immobile collectibles or obstacles, constantly moving collectibles requiring constant trajectory adjustment, unpredictable obstacles coming from the ground and more.
::::
::::{#right}
{{< video https://xcit.org/extras/behaverse-org/video/training/training_section2_right-lg-1080p.mp4 >}}
Independently from the challenge, the scenery of the game can be flexibly changed to provide a varied visual environment without affecting the cognitive demands.
::::
:::
