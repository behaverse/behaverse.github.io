...
```{=html}
<video autoplay muted loop class="w-100">
    <source type="video/mp4" src="https://xcit.org/extras/behaverse-org/video/training/training_section2_left-lg-1080p.mp4 ">
</video>
```
...
```{=html}
<video autoplay muted loop class="w-100">
    <source type="video/mp4" src="https://xcit.org/extras/behaverse-org/video/training/training_section2_right-lg-1080p.mp4">
</video>
```
